  ...
  return (
    <>
      ...
      <main className="flex-1 bg-gradient-to-b from-purple-50 to-white dark:from-purple-950 dark:to-slate-900 dark:text-white overflow-y-auto">
        <div className="container mx-auto px-4 py-4 h-full flex flex-col justify-center">
          ...
          <div className="mt-8 md:mt-12 grid grid-cols-1 md:grid-cols-3 gap-4 md:gap-6">
            {[
              ...
              <motion.div
                ...
                className="bg-white rounded-xl p-4 shadow-md border border-purple-100 hover:shadow-lg hover:border-purple-200 transition-all dark:bg-slate-800 dark:border-purple-800 dark:hover:border-purple-700"
              >
