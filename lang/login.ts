...
const loginTranslations = {
    en: {
      ...
      errorGoogleAccountNotExists: "No account found with this Google email. Please sign up first or use a different Google account.",
      errorAccountExistsSignupAttempt: "An account with this email already exists. Please sign in with your existing account.",
    ...
    es: {
      ...
      errorGoogleAccountNotExists: "No se encontró una cuenta con este email de Google. Por favor regístrate primero o usa una cuenta de Google diferente.",
      errorAccountExistsSignupAttempt: "Ya existe una cuenta con este email. Por favor inicia sesión con tu cuenta existente.",
    ...
    zh: {
      ...
      errorGoogleAccountNotExists: "未找到此Google邮箱的账户。请先注册或使用其他Google账户。",
      errorAccountExistsSignupAttempt: "此邮箱已有账户。请使用现有账户登录。",
      signupButton: "注册",
